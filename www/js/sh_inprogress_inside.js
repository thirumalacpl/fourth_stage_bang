...
//alert(oneemp);
  $('.ssnewin').append('<li><a href="http://staging.eimpressive.com/documents/addressid/'+oneemp+'"><img src="http://staging.eimpressive.com/documents/addressid/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
