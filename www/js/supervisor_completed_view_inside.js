...
//alert(oneemp);
  $('.s22').append('<li><a href="http://staging.eimpressive.com/documents/addressid/'+oneemp+'"><img src="http://staging.eimpressive.com/documents/addressid/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
if (j == 0 ){
  ...
  $('.s2').append('<li><a href="http://staging.eimpressive.com/documents/addressid/'+one+'"><img src="http://staging.eimpressive.com/documents/addressid/'+one+'"  style="height: 100%;width:100%"></a></li>');
...
if (j == 1 ){
  ...
  //alert(oneo+'two');
  $('.s2').append('<li><a href="http://staging.eimpressive.com/documents/addressid/'+oneo+'"><img src="http://staging.eimpressive.com/documents/addressid/'+oneo+'"  style="height: 100%;width:100%"></a></li>');
