...
//alert(oneemp);
  $('.sddq').append('<li><a href="http://staging.eimpressive.com/documents/addressid/'+oneemp+'"><img src="http://staging.eimpressive.com/documents/addressid/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
$('.s').append('<li><a href="http://staging.eimpressive.com/documents/addressid/'+one+'"><img src="http://staging.eimpressive.com/documents/addressid/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
$('.s').append('<li><a href="http://staging.eimpressive.com/documents/addressid/'+oneo+'"><img src="http://staging.eimpressive.com/documents/addressid/'+oneo+'"  style="height: 300px;width:350px"></a></li>');
