...
$.ajax({url: 'http://staging.eimpressive.com/slim-cor/dashinprogress.php?region='+region+"&user_id="+user_id,
  data:$('#new').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
$.ajax({url: 'http://staging.eimpressive.com/slim-cor/dashverified.php?region='+region+"&user_id="+user_id,
  data:$('#new').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
//alert(region+'verified');
$.ajax({url: 'http://staging.eimpressive.com/slim-cor/dash_not_verified.php?region='+region+"&user_id="+user_id,
  data:$('#new').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
//alert(region+'verified');
$.ajax({url: 'http://staging.eimpressive.com/slim-cor/completed.php?region='+region+"&user_id="+user_id,
  data:$('#newt').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
